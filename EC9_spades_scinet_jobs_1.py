...
for i in isolates:
	...
	with open(output_file, 'w') as outfile1:
		...
		outfile1.write("\n" + "spades.py --careful -1 /scratch/d/dguttman/cizydor/ecoli_trim5/paired/" + i + "_R1.fastq -2 /scratch/d/dguttman/cizydor/ecoli_trim5/paired/" + i + "_R2.fastq -o /scratch/d/dguttman/cizydor/EC9_spades_assemblies/" + i + " -t 8" +  "\n")
