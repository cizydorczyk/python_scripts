...
parser.add_argument("--assembly_dir", help="dir with fastq files")
...
art_cmd = "/home/cizydorczyk/art_bin_MountRainier/art_illumina -ss MSv3 -i " + args.assembly_dir + args.isolate + "_genomic.fna -l 250 -p -m 400 -s 110 -f 75 -o " + args.output_dir + args.isolate + " -na -rs 42"
