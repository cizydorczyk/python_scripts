...
F18_quast_jobs.CreateQuastJobs(s_quast_raw_assemblies_dir, s_unicycler_assemblies_dir,
quast_raw_jobs_dir, isolate_list, args.nt, args.walle, args.wallm, mem,
mem_max, args.assembler)
