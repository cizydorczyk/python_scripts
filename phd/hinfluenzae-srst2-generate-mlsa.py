...
for line in raw_mlst_data:
    ...
    if '*' not in alleles and '?' not in alleles:
        ...
        gene1_seq = dict1[genes[0] + "_" + line_[2]]
        gene2_seq = dict2[genes[1] + "_" + line_[3]]
        gene3_seq = dict3[genes[2] + "_" + line_[4]]
        gene4_seq = dict4[genes[3] + "_" + line_[5]]
        gene5_seq = dict5[genes[4] + "_" + line_[6]]
        gene6_seq = dict6[genes[5] + "_" + line_[7]]
        gene7_seq = dict7[genes[6] + "_" + line_[8]]
