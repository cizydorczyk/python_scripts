...
parser.add_argument("--synergy_project_dir", help="path to main project dir on synergy")
...
isolate_output_dir = os.path.join(args.synergy_project_dir, args.isolate, "iqtree/")
...
h9 = '#BSUB -o ' + args.synergy_project_dir + args.isolate + ".out"
h10 = '#BSUB -e ' + args.synergy_project_dir + args.isolate + ".err"

header = h1+'\n\n'+h2+'\n'+h3+'\n'+h4+'\n'+h5+'\n'+h6+'\n'+h7+'\n'+h8+'\n'+h9+'\n'+h10+'\n\n'

iqtree_cmd = "iqtree -nt AUTO -s " + args.input_fa + " -bb " + args.bb + " -m " + args.model + " -pre " + args.synergy_project_dir + args.isolate + ".iqtree -ntmax " + args.nt
