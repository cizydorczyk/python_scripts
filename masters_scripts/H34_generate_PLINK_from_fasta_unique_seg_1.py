...
script, fasta, positions_file, output_ped2, output_map2, output_matrix = argv
...
def convert_to_binary_01(column_vector):
    key_set = list(set(column_vector))
    allele_a = key_set[0]
    allele_b = key_set[1]
...
# Write SNP matrix to file:
out3 = df1.apply(convert_to_binary_01, axis=0)
out3.to_csv(path_or_buf=output_matrix, sep='\t')
